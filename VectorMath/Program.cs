...
namespace VectorMath
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Operatoe:{one + two}");

            Console.WriteLine($"Subtraction:{one - two}");

            Console.WriteLine($"Scalar multiplication:{2 * one}");

            Console.WriteLine($"Scalar multiplication:{one * 5}");

            Console.WriteLine($"Should no be equal:{one == two}");

            Console.WriteLine($"Should be equal:{one == new Vector3(3,4,5)}");


            Console.WriteLine($"Perincrement:{++one}");
